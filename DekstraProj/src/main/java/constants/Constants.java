...
public class Constants
{
    ...
    public static final double ONE_NODE_RADIUS_CIRCLE_EDGE_ON_CANVAS = 30;
    public static final double ONE_NODE_CIRCLE_EDGE_STRANGE_OFFSET = 10;
    ...
    public static final double CURVE_EDGE_OFFSET_ON_CANVAS = 20;
}
